...
// function Avatar(props) { /* Начало функции*/
  // const { theme } = props;
  /* Начало Return*/
  function Avatar() {
  const theme = {
  ...
  return (
    ...
    {/* <g  id="path13">
    <path d="M -92 250 A 75 75 0 1 0 -95 250 Z" fill={theme.accentColor}
     transform="translate(210, 170)"/>
      <path d="M -92 250 A 75 75 0 1 0 -95 250 Z" fill={theme.accentColor}
     transform="translate(290, 210)"/>
      <path d="M -92 250 A 50 50 0 1 0 -95 250 Z" fill={theme.accentColor}
  ...
  {/* <g id="path13"  opacity="0.9" fill={theme.additionalColor}>
    <path d="M -92 250 A 65 65 0 1 0 -95 250 Z" 
     transform="translate(210, 165)"/>
      <path d="M -92 250 A 65 65 0 1 0 -95 250 Z" 
     transform="translate(290, 205)"/>
      <path d="M -92 250 A 40 40 0 1 0 -95 250 Z"
     transform="translate(360, 195)"/>
    <path d="M -92 250 A 65 65 0 1 0 -95 250 Z"
...
{/* <g id="path13"  opacity="0.4" fill={theme.primaryColor}>
    <path d="M -92 250 A 75 75 0 1 0 -95 250 Z" 
     transform="translate(210, 175)"/>
      <path d="M -92 250 A 75 75 0 1 0 -95 250 Z" 
     transform="translate(290, 215)"/>
      <path d="M -92 250 A 50 50 0 1 0 -95 250 Z"
     transform="translate(360, 205)"/>
    <path d="M -92 250 A 75 75 0 1 0 -95 250 Z"
     ...
     {/* <g id="path13"  opacity="0.5" fill={theme.primaryColor}>
    <path d="M -92 250 A 65 65 0 1 0 -95 250 Z" 
     transform="translate(210, 165)"/>
      <path d="M -92 250 A 65 65 0 1 0 -95 250 Z" 
     transform="translate(290, 205)"/>
...
{/* Облачко финиш */}
     ...
     {/* <g id="path13"  opacity="0.5" fill={theme.thirdColor}>
    <path d="M -92 250 A 50 50 0 1 0 -95 250 Z" 
     transform="translate(210, 165)"/>
      <path d="M -92 250 A 50 50 0 1 0 -95 250 Z" 
     transform="translate(290, 185)"/>
      <path d="M -92 250 A 25 25 0 1 0 -95 250 Z"
     transform="translate(340, 175)"/>
    <path d="M -92 250 A 50 50 0 1 0 -95 250 Z"
...
{/* <g id="path13"  opacity="0.5" fill={theme.primaryColor}>
    <path d="M -92 250 A 75 75 0 1 0 -95 250 Z" 
     transform="translate(210, 155)"/>
      <path d="M -92 250 A 75 75 0 1 0 -95 250 Z" 
     transform="translate(290, 195)"/>
      <path d="M -92 250 A 50 50 0 1 0 -95 250 Z"
     transform="translate(360, 185)"/>
    <path d="M -92 250 A 75 75 0 1 0 -95 250 Z"
...
{/* <g id="path12"  opacity="0.8" fill={theme.primaryColor}>
    <path d="M -92 250 A 35 35 0 1 0 -95 250 Z" 
     ...
     transform="translate(250, 135)"/>
      <path d="M -92 250 A 20 20 0 1 0 -95 250 Z"
...
{/* <g id="path12"  opacity="0.5" fill={theme.primaryColor}>
    <path d="M -92 250 A 65 65 0 1 0 -95 250 Z" 
     transform="translate(210, 165)"/>
      <path d="M -92 250 A 65 65 0 1 0 -95 250 Z" 
     transform="translate(290, 205)"/>
...
<g id="head">
  ...
  {/* <svg width="100" height="100"> */}
  {/* <rect x="107" y="220" width="30" height="30" fill="blue" />
  <rect x="0" y="50" width="30" height="30" fill="red" transform="translate(50, 0)" /> */}
{/* </svg> */}

    {/* <rect rx="3" id="rect1150" fill={theme.accentColor} width="15" height="15" x="-92.187965" y="245.78786" transform="rotate(-45)" /> */}
    {/* <path d="M -92 250 A 15 15 0 1 0 -107 250 Z" fill={theme.accentColor} />
    <path d="M -102 225 Q -95 200 -80 225 Z" fill="green" /> */}
    {/* <path d="M -92 250
         A 15 15 0 1 0 -107 250
         Q -102 245 -94 248
         L -92 250
         Q -102 250 -92 250 Z" fill={theme.accentColor} /> */}



    {/* <path d="M -92 250 A 15 15 0 1 0 -102 250 Z" fill={theme.accentColor} /> */}
    {/* <path d="M -102 225 Q -95 200 -80 225 Z" fill="green" /> */}

    <path
  // d="M 250 -92
  //    A 15 15 0 1 0 250 -107
  //    Q 255 -92 252 -84
  //    L 250 -82
  //    Q 250 -92 250 -82 Z
  //    M 250 -92
  ...
  //        L -92 250
  //        Q -102 250 -92 250 Z"
  // transform="translate(-92.187965 245.78786) rotate(-90)" // Смещение по X и Y, а затем поворот на 90 градусов
  // fill={theme.accentColor}
/>
...
{/* </svg> */}
  ...
  // fill="green" 
      ...
      {/* <path d="M -100 225 Q -100 210 -80 225 Z" fill="green" /> */}
  </g>
...
/* Окончание кода*/
  ...
  );/* Окончание скoбки Return*/
}/* Закрытие скобки функции I*/
